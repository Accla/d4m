...
/** 
 * <code>MySequenceFile</code>s are flat files consisting of binary key/value 
 * pairs.
 * 
 * <p><code>MySequenceFile</code> provides {@link Writer}, {@link Reader} and
 * {@link Sorter} classes for writing, reading and sorting respectively.</p>
 * 
 * There are three <code>MySequenceFile</code> <code>Writer</code>s based on the 
 ...
 * provided by the <code>MySequenceFile</code> to chose the preferred format.</p>
 *
 * <p>The {@link Reader} acts as the bridge and can read any of the above 
 * <code>MySequenceFile</code> formats.</p>
 *
 * <h4 id="Formats">MySequenceFile Formats</h4>
 * 
 * <p>Essentially there are 3 different formats for <code>MySequenceFile</code>s
...
public class MySequenceFile {
   ...
   * @deprecated Use the one of the many MySequenceFile.createWriter methods to specify
   *             the {@link CompressionType} while creating the {@link MySequenceFile} or
   *             {@link org.apache.hadoop.mapred.SequenceFileOutputFormat#setOutputCompressionType(org.apache.hadoop.mapred.JobConf, org.apache.hadoop.io.MySequenceFile.CompressionType)}
  ...
  public static Writer
    ...
    if ((codec instanceof GzipCodec) &&
      ...
      throw new IllegalArgumentException("MySequenceFile doesn't work with " +
  ...
  public static class Writer implements java.io.Closeable {
     ...
     * immediately after calling {@link MySequenceFile.Reader#seek(long)} with a position
     * returned by this method, {@link MySequenceFile.Reader#next(Writable)} may be called.  However
  ...
  public static class Reader implements java.io.Closeable {
     ...
     *                  reader {@link MySequenceFile.Sorter.cloneFileAttributes}, 
    ...
    public synchronized int next(DataOutputBuffer buffer) throws IOException {
      ...
      if (blockCompressed) {
        throw new IOException("Unsupported call for block-compressed" +
                              " SequenceFiles - use MySequenceFile.Reader.next(DataOutputStream, ValueBytes)");
      }
      try {
     ...
     * MySequenceFile.Writer#getLength()} when writing this file.  To seek to an arbitrary
     * position, use {@link MySequenceFile.Reader#sync(long)}.
     */
