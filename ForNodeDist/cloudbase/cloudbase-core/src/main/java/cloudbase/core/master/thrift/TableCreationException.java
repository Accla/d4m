...
public class TableCreationException extends Exception implements TBase, java.io.Serializable {
  public String table;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TableCreationException)
      return this.equals((TableCreationException)that);
    return false;
  }

  public boolean equals(TableCreationException that) {
    if (that == null)
      return false;
  ...
  public void write(TProtocol oprot) throws TException {
    TStruct struct = new TStruct("TableCreationException");
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TableCreationException(");
    sb.append("table:");
