%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Benchmark associative array CatKey multiply performance.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i = 1:numel(n);
  ...
  tic;
    C = CatKeyMul(A,B);                     % Perform associative array CatKey multiply.
  assoc_time(i) = toc;
...
AcatKeyResults  = Assoc(r,'N,',n.') + Assoc(r,'M,',m.') + Assoc(r,'time,',assoc_time.') + Assoc(r,'GByte,',assoc_gbytes.') + Assoc(r,'GFlop,', assoc_gflops.') + Assoc(r,'MemFrac,',(assoc_gbytes./MaxGB).') + Assoc(r,'ProcFrac,', (assoc_gflops./MaxGF).');

displayFull(AcatKeyResults);                % Show results in tabular form.
