...
public class D4mDbInsert {
    ...
    public void doProcessingCurrent() throws IOException, CBException, CBSecurityException, TableNotFoundException, MutationsRejectedException {
    ...
    public void doLoadTest() {
        ...
        @SuppressWarnings("static-access") // Save
