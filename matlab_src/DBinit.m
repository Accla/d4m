...
javaaddpath([d4m_home fd 'lib' fd 'd4m_api_java-2.6.1-SNAPSHOT.jar']);
...
javaaddpath([d4m_home fd 'libext' fd 'hadoop-hdfs-2.3.0.jar']);
...
javaaddpath([d4m_home fd 'libext' fd 'tmp']);
...
%Common jars
javaaddpath({ ...
[d4m_home fd 'lib' fd 'd4m_api_java-2.6.1-SNAPSHOT.jar'] ...
...
, [d4m_home fd 'libext' fd 'hadoop-hdfs-2.3.0.jar'] ...
