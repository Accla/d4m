% insert Inserts given list of arrays into specified array
% Usage:
%     insert(Tdest, T1, T2, T3, ...)
%
function varargout = insert(Tdest, varargin)
...
for k = 1:length(varargin)
    ...
    query = sprintf('insert(%s, %s)', varargin{k}, destName);
